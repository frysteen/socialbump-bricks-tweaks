...
class SBBT_Acf_Svg_Icons {
	...
	public static function print_styles() {
		$css    = '';
		$colour = SBBT_Modules::sanitize_css_colour( (string) SBBT_Modules::instance()->setting( 'fix-acf-cpt-svg-icons', 'colour' ) );
		...
		if ( $css !== '' ) {
			echo '<style id="sbbt-acf-svg-icons">' . $css . '</style>' . "\n";
		}
	}
}