...
class SB_Element_Image_Carousel extends \Bricks\Element {
	...
	public function set_control_groups() {
		$this->control_groups['layout']   = [ 'title' => esc_html__( 'Layout', 'sb-bricks-tweaks' ), 'tab' => 'content' ];
		$this->control_groups['carousel'] = [ 'title' => esc_html__( 'Carousel', 'sb-bricks-tweaks' ), 'tab' => 'content' ];
		$this->control_groups['autoplay'] = [ 'title' => esc_html__( 'Autoplay', 'sb-bricks-tweaks' ), 'tab' => 'content' ];
		$this->control_groups['arrows']   = [ 'title' => esc_html__( 'Arrows', 'sb-bricks-tweaks' ), 'tab' => 'content' ];
		$this->control_groups['dots']     = [ 'title' => esc_html__( 'Pagination', 'sb-bricks-tweaks' ), 'tab' => 'content' ];
		$this->control_groups['lightbox'] = [ 'title' => esc_html__( 'Lightbox', 'sb-bricks-tweaks' ), 'tab' => 'content' ];
		$this->control_groups['seo']      = [ 'title' => esc_html__( 'Alt text', 'sb-bricks-tweaks' ), 'tab' => 'content' ];
	}
	...
	public function set_controls() {
		...
		$this->controls['items'] = [
			'tab'   => 'content',
			'type'  => 'image-gallery',
			'label' => esc_html__( 'Images', 'sb-bricks-tweaks' ),
		];

		$this->controls['order'] = [
			'tab'         => 'content',
			'label'       => esc_html__( 'Order', 'sb-bricks-tweaks' ),
			'type'        => 'select',
			'options'     => [
				'as-is'  => esc_html__( 'As arranged', 'sb-bricks-tweaks' ),
				'random' => esc_html__( 'Random each page load', 'sb-bricks-tweaks' ),
			],
			'inline'      => true,
			'default'     => 'as-is',
			'description' => esc_html__( 'Page caching will freeze a random order until the cache clears.', 'sb-bricks-tweaks' ),
		];
		...
		$this->controls['aspectRatio'] = [
			'tab'         => 'content',
			'group'       => 'layout',
			'label'       => esc_html__( 'Aspect ratio', 'sb-bricks-tweaks' ),
			'type'        => 'text',
			'inline'      => true,
			'placeholder' => '3/2',
			'breakpoints' => true,
			'description' => esc_html__( 'For example 1/1, 4/3, 16/9. Leave empty to keep the natural image ratio.', 'sb-bricks-tweaks' ),
		];

		$this->controls['objectFit'] = [
			'tab'      => 'content',
			'group'    => 'layout',
			'label'    => esc_html__( 'Object fit', 'sb-bricks-tweaks' ),
			'type'     => 'select',
			'options'  => [
				'cover'   => 'cover',
				'contain' => 'contain',
		...
		$this->controls['objectPosition'] = [
			'tab'         => 'content',
			'group'       => 'layout',
			'label'       => esc_html__( 'Object position', 'sb-bricks-tweaks' ),
			'type'        => 'text',
			'inline'      => true,
		...
		$this->controls['radius'] = [
			'tab'         => 'content',
			'group'       => 'layout',
			'label'       => esc_html__( 'Slide border radius', 'sb-bricks-tweaks' ),
			'type'        => 'number',
			'units'       => true,
			'inline'      => true,
			'placeholder' => '0px',
		...
		$this->controls['caption'] = [
			'tab'         => 'content',
			'group'       => 'layout',
			'label'       => esc_html__( 'Caption', 'sb-bricks-tweaks' ),
			'type'        => 'select',
			'options'     => [
				''        => esc_html__( 'None', 'sb-bricks-tweaks' ),
				'below'   => esc_html__( 'Below image', 'sb-bricks-tweaks' ),
				'overlay' => esc_html__( 'Overlay', 'sb-bricks-tweaks' ),
			],
			'inline'      => true,
			'description' => esc_html__( 'Uses the caption set on the media item.', 'sb-bricks-tweaks' ),
		];

		$this->controls['captionTypography'] = [
			'tab'      => 'content',
			'group'    => 'layout',
			'label'    => esc_html__( 'Caption typography', 'sb-bricks-tweaks' ),
			'type'     => 'typography',
		...
		$this->controls['fadeEdges'] = [
			'tab'         => 'content',
			'group'       => 'layout',
			'label'       => esc_html__( 'Fade edges', 'sb-bricks-tweaks' ),
			'type'        => 'checkbox',
			'description' => esc_html__( 'Slides fade out at the edges of the carousel, whatever sits behind them.', 'sb-bricks-tweaks' ),
		];

		$this->controls['fadeSides'] = [
			'tab'      => 'content',
			'group'    => 'layout',
			'label'    => esc_html__( 'Fade which sides', 'sb-bricks-tweaks' ),
			'type'     => 'select',
			'options'  => [
				'both'  => esc_html__( 'Both', 'sb-bricks-tweaks' ),
				'left'  => esc_html__( 'Left only', 'sb-bricks-tweaks' ),
				'right' => esc_html__( 'Right only', 'sb-bricks-tweaks' ),
			],
			'inline'   => true,
			'default'  => 'both',
		...
		$this->controls['fadeWidth'] = [
			'tab'         => 'content',
			'group'       => 'layout',
			'label'       => esc_html__( 'Fade width', 'sb-bricks-tweaks' ),
			'type'        => 'number',
			'units'       => true,
			'inline'      => true,
			'default'     => '80px',
			'breakpoints' => true,
			'required'    => [ 'fadeEdges', '=', true ],
			'description' => esc_html__( 'Percentages work too, for example 10%.', 'sb-bricks-tweaks' ),
		];
		/* ---------------- Carousel ---------------- */
		$this->controls['perPage'] = [
			'tab'         => 'content',
			'group'       => 'carousel',
			'label'       => esc_html__( 'Slides to show', 'sb-bricks-tweaks' ),
			'type'        => 'number',
			'min'         => 1,
			'step'        => 0.5,
			'inline'      => true,
			'default'     => 3,
			'breakpoints' => true,
			'description' => esc_html__( 'Decimals such as 1.5 show part of the next slide.', 'sb-bricks-tweaks' ),
		];

		$this->controls['perMove'] = [
			'tab'         => 'content',
			'group'       => 'carousel',
			'label'       => esc_html__( 'Slides to move', 'sb-bricks-tweaks' ),
			'type'        => 'number',
			'min'         => 1,
			'inline'      => true,
			'default'     => 1,
		...
		$this->controls['gap'] = [
			'tab'         => 'content',
			'group'       => 'carousel',
			'label'       => esc_html__( 'Gap', 'sb-bricks-tweaks' ),
			'type'        => 'number',
			'units'       => true,
			'inline'      => true,
			'default'     => '20px',
		...
		$this->controls['peek'] = [
			'tab'         => 'content',
			'group'       => 'carousel',
			'label'       => esc_html__( 'Edge peek', 'sb-bricks-tweaks' ),
			'type'        => 'number',
			'units'       => true,
			'inline'      => true,
			'breakpoints' => true,
			'description' => esc_html__( 'Padding on the left and right of the track, so the neighbouring slides peek in.', 'sb-bricks-tweaks' ),
		];

		$this->controls['type'] = [
			'tab'     => 'content',
			'group'   => 'carousel',
			'label'   => esc_html__( 'Transition', 'sb-bricks-tweaks' ),
			'type'    => 'select',
			'options' => [
				'loop'  => esc_html__( 'Loop', 'sb-bricks-tweaks' ),
				'slide' => esc_html__( 'Slide (no loop)', 'sb-bricks-tweaks' ),
				'fade'  => esc_html__( 'Fade', 'sb-bricks-tweaks' ),
			],
			'inline'  => true,
			'default' => 'loop',
		];
		...
		$this->controls['fadeInfo'] = [
			...
			'group'    => 'carousel',
			'type'     => 'info',
			'content'  => esc_html__( 'Fade forces one slide at a time.', 'sb-bricks-tweaks' ),
			'required' => [ 'type', '=', 'fade' ],
		];
		...
		$this->controls['speed'] = [
			'tab'     => 'content',
			'group'   => 'carousel',
			'label'   => esc_html__( 'Transition speed (ms)', 'sb-bricks-tweaks' ),
			'type'    => 'number',
			'min'     => 0,
			'inline'  => true,
			'default' => 600,
		...
		$this->controls['easing'] = [
			'tab'         => 'content',
			'group'       => 'carousel',
			'label'       => esc_html__( 'Easing', 'sb-bricks-tweaks' ),
			'type'        => 'text',
			'inline'      => true,
		...
		$this->controls['drag'] = [
			'tab'     => 'content',
			'group'   => 'carousel',
			'label'   => esc_html__( 'Drag', 'sb-bricks-tweaks' ),
			'type'    => 'select',
			'options' => [
				'true'  => esc_html__( 'On', 'sb-bricks-tweaks' ),
				'free'  => esc_html__( 'Free drag', 'sb-bricks-tweaks' ),
				'false' => esc_html__( 'Off', 'sb-bricks-tweaks' ),
			],
			'inline'  => true,
			'default' => 'true',
		];
		...
		$this->controls['wheel'] = [
			'tab'   => 'content',
			'group' => 'carousel',
			'label' => esc_html__( 'Mouse wheel control', 'sb-bricks-tweaks' ),
			'type'  => 'checkbox',
		];
		...
		$this->controls['keyboard'] = [
			'tab'         => 'content',
			'group'       => 'carousel',
			'label'       => esc_html__( 'Keyboard arrows', 'sb-bricks-tweaks' ),
			'type'        => 'checkbox',
			'default'     => true,
			'description' => esc_html__( 'Arrow keys move the carousel while the pointer is over it, or while it has focus.', 'sb-bricks-tweaks' ),
		];

		$this->controls['startIndex'] = [
			'tab'     => 'content',
			'group'   => 'carousel',
			'label'   => esc_html__( 'Start at slide', 'sb-bricks-tweaks' ),
			'type'    => 'number',
			'min'     => 1,
			'inline'  => true,
			'default' => 1,
		...
		$this->controls['rewind'] = [
			'tab'      => 'content',
			'group'    => 'carousel',
			'label'    => esc_html__( 'Rewind to start at the end', 'sb-bricks-tweaks' ),
			'type'     => 'checkbox',
			'required' => [ 'type', '!=', 'loop' ],
		];
		...
		$this->controls['rtl'] = [
			'tab'   => 'content',
			'group' => 'carousel',
			'label' => esc_html__( 'Right to left', 'sb-bricks-tweaks' ),
			'type'  => 'checkbox',
		];
		...
		$this->controls['autoplayMode'] = [
			'tab'     => 'content',
			'group'   => 'autoplay',
			'label'   => esc_html__( 'Mode', 'sb-bricks-tweaks' ),
			'type'    => 'select',
			'options' => [
				'off'        => esc_html__( 'Off', 'sb-bricks-tweaks' ),
				'slide'      => esc_html__( 'Slide by slide', 'sb-bricks-tweaks' ),
				'continuous' => esc_html__( 'Continuous scroll', 'sb-bricks-tweaks' ),
			],
			'inline'  => true,
			'default' => 'off',
		];
		...
		$this->controls['continuousInfo'] = [
			...
			'group'    => 'autoplay',
			'type'     => 'info',
			'content'  => esc_html__( 'Continuous scroll never stops and never jumps. It forces looping, and slides are repeated behind the scenes when there are too few to fill the loop.', 'sb-bricks-tweaks' ),
		...
		$this->controls['autoplayInterval'] = [
			'tab'      => 'content',
			'group'    => 'autoplay',
			'label'    => esc_html__( 'Interval (ms)', 'sb-bricks-tweaks' ),
			'type'     => 'number',
			'min'      => 100,
			'inline'   => true,
			'default'  => 4000,
		...
		$this->controls['autoScrollSpeed'] = [
			'tab'      => 'content',
			'group'    => 'autoplay',
			'label'    => esc_html__( 'Scroll speed', 'sb-bricks-tweaks' ),
			'type'     => 'number',
			'min'      => 0.1,
			'step'     => 0.1,
			'inline'   => true,
		...
		$this->controls['autoScrollReverse'] = [
			'tab'      => 'content',
			'group'    => 'autoplay',
			'label'    => esc_html__( 'Reverse direction', 'sb-bricks-tweaks' ),
			'type'     => 'checkbox',
			'required' => [ 'autoplayMode', '=', 'continuous' ],
		];
		...
		$this->controls['pauseOnHover'] = [
			'tab'      => 'content',
			'group'    => 'autoplay',
			'label'    => esc_html__( 'Pause on hover', 'sb-bricks-tweaks' ),
			'type'     => 'checkbox',
			'default'  => true,
		...
		$this->controls['pauseOnFocus'] = [
			'tab'      => 'content',
			'group'    => 'autoplay',
			'label'    => esc_html__( 'Pause on focus', 'sb-bricks-tweaks' ),
			'type'     => 'checkbox',
			'default'  => true,
			'required' => [ 'autoplayMode', '!=', 'off' ],
		];
		...
		$this->controls['progressBar'] = [
			'tab'      => 'content',
			'group'    => 'autoplay',
			'label'    => esc_html__( 'Show progress bar', 'sb-bricks-tweaks' ),
			'type'     => 'checkbox',
			'required' => [ 'autoplayMode', '=', 'slide' ],
		];
		...
		$this->controls['progressBarColor'] = [
			'tab'      => 'content',
			'group'    => 'autoplay',
			'label'    => esc_html__( 'Progress bar colour', 'sb-bricks-tweaks' ),
			'type'     => 'color',
		...
		$this->controls['showArrows'] = [
			'tab'     => 'content',
			'group'   => 'arrows',
			'label'   => esc_html__( 'Show arrows', 'sb-bricks-tweaks' ),
			'type'    => 'checkbox',
			'default' => true,
		];
		...
		$this->controls['arrowPosition'] = [
			'tab'      => 'content',
			'group'    => 'arrows',
			'label'    => esc_html__( 'Position', 'sb-bricks-tweaks' ),
			'type'     => 'select',
			'options'  => [
				'inside'       => esc_html__( 'Inside edges', 'sb-bricks-tweaks' ),
				'outside'      => esc_html__( 'Outside edges', 'sb-bricks-tweaks' ),
				'above-left'   => esc_html__( 'Above left', 'sb-bricks-tweaks' ),
				'above-right'  => esc_html__( 'Above right', 'sb-bricks-tweaks' ),
				'below-left'   => esc_html__( 'Below left', 'sb-bricks-tweaks' ),
				'below-center' => esc_html__( 'Below centre', 'sb-bricks-tweaks' ),
				'below-right'  => esc_html__( 'Below right', 'sb-bricks-tweaks' ),
			],
			'inline'   => true,
			'default'  => 'inside',
		...
		$this->controls['prevIcon'] = [
			'tab'      => 'content',
			'group'    => 'arrows',
			'label'    => esc_html__( 'Previous icon', 'sb-bricks-tweaks' ),
			'type'     => 'icon',
			'required' => [ 'showArrows', '=', true ],
		];
		...
		$this->controls['nextIcon'] = [
			'tab'      => 'content',
			'group'    => 'arrows',
			'label'    => esc_html__( 'Next icon', 'sb-bricks-tweaks' ),
			'type'     => 'icon',
			'required' => [ 'showArrows', '=', true ],
		];
		...
		$this->controls['arrowSize'] = [
			'tab'      => 'content',
			'group'    => 'arrows',
			'label'    => esc_html__( 'Button size', 'sb-bricks-tweaks' ),
			'type'     => 'number',
			'units'    => true,
			'inline'   => true,
			'default'  => '44px',
		...
		$this->controls['arrowIconSize'] = [
			'tab'      => 'content',
			'group'    => 'arrows',
			'label'    => esc_html__( 'Icon size', 'sb-bricks-tweaks' ),
			'type'     => 'number',
			'units'    => true,
			'inline'   => true,
			'default'  => '18px',
		...
		$this->controls['arrowOffset'] = [
			'tab'      => 'content',
			'group'    => 'arrows',
			'label'    => esc_html__( 'Offset', 'sb-bricks-tweaks' ),
			'type'     => 'number',
			'units'    => true,
			'inline'   => true,
			'default'  => '12px',
		...
		$this->controls['arrowColor'] = [
			'tab'      => 'content',
			'group'    => 'arrows',
			'label'    => esc_html__( 'Icon colour', 'sb-bricks-tweaks' ),
			'type'     => 'color',
			'required' => [ 'showArrows', '=', true ],
		];
		...
		$this->controls['arrowBg'] = [
			'tab'      => 'content',
			'group'    => 'arrows',
			'label'    => esc_html__( 'Background', 'sb-bricks-tweaks' ),
			'type'     => 'color',
			'required' => [ 'showArrows', '=', true ],
		];
		...
		$this->controls['arrowRadius'] = [
			'tab'      => 'content',
			'group'    => 'arrows',
			'label'    => esc_html__( 'Button radius', 'sb-bricks-tweaks' ),
			'type'     => 'number',
			'units'    => true,
			'inline'   => true,
			'default'  => '50%',
		...
		$this->controls['arrowBorder'] = [
			'tab'      => 'content',
			'group'    => 'arrows',
			'label'    => esc_html__( 'Border', 'sb-bricks-tweaks' ),
			'type'     => 'border',
		...
		$this->controls['showDots'] = [
			'tab'   => 'content',
			'group' => 'dots',
			'label' => esc_html__( 'Show pagination', 'sb-bricks-tweaks' ),
			'type'  => 'checkbox',
		];
		...
		$this->controls['dotsStyle'] = [
			'tab'      => 'content',
			'group'    => 'dots',
			'label'    => esc_html__( 'Style', 'sb-bricks-tweaks' ),
			'type'     => 'select',
			'options'  => [
				'dot' => esc_html__( 'Dots', 'sb-bricks-tweaks' ),
				'bar' => esc_html__( 'Bars', 'sb-bricks-tweaks' ),
			],
			'inline'   => true,
			'default'  => 'dot',
		...
		$this->controls['dotsPosition'] = [
			...
			'type'     => 'select',
			'options'  => [
				'below'   => esc_html__( 'Below the carousel', 'sb-bricks-tweaks' ),
				'overlay' => esc_html__( 'Over the carousel', 'sb-bricks-tweaks' ),
			],
			'inline'   => true,
			'default'  => 'below',
			'required' => [ 'showDots', '=', true ],
		...
		$this->controls['dotsAlign'] = [
			'tab'      => 'content',
			'group'    => 'dots',
			'label'    => esc_html__( 'Alignment', 'sb-bricks-tweaks' ),
			'type'     => 'select',
			'options'  => [
				'flex-start' => esc_html__( 'Left', 'sb-bricks-tweaks' ),
				'center'     => esc_html__( 'Centre', 'sb-bricks-tweaks' ),
				'flex-end'   => esc_html__( 'Right', 'sb-bricks-tweaks' ),
			],
			'inline'   => true,
			'default'  => 'center',
			'required' => [ 'showDots', '=', true ],
		...
		$this->controls['dotSize'] = [
			'tab'      => 'content',
			'group'    => 'dots',
			'label'    => esc_html__( 'Size', 'sb-bricks-tweaks' ),
			'type'     => 'number',
			'units'    => true,
			'inline'   => true,
			'default'  => '10px',
		...
		$this->controls['dotColor'] = [
			'tab'      => 'content',
			'group'    => 'dots',
			'label'    => esc_html__( 'Colour', 'sb-bricks-tweaks' ),
			'type'     => 'color',
			'required' => [ 'showDots', '=', true ],
		];
		...
		$this->controls['dotActiveColor'] = [
			'tab'      => 'content',
			'group'    => 'dots',
			'label'    => esc_html__( 'Active colour', 'sb-bricks-tweaks' ),
			'type'     => 'color',
			'required' => [ 'showDots', '=', true ],
		];
		...
		$this->controls['lightbox'] = [
			'tab'   => 'content',
			'group' => 'lightbox',
			'label' => esc_html__( 'Open images in a lightbox', 'sb-bricks-tweaks' ),
			'type'  => 'checkbox',
		];
		...
		$this->controls['lightboxImageSize'] = [
			'tab'      => 'content',
			'group'    => 'lightbox',
			'label'    => esc_html__( 'Lightbox image size', 'sb-bricks-tweaks' ),
			'type'     => 'select',
		...
		$this->controls['lightboxCaption'] = [
			'tab'      => 'content',
			'group'    => 'lightbox',
			'label'    => esc_html__( 'Show caption in lightbox', 'sb-bricks-tweaks' ),
			'type'     => 'checkbox',
			'required' => [ 'lightbox', '=', true ],
		];
		...
		$this->controls['lightboxId'] = [
			'tab'         => 'content',
			'group'       => 'lightbox',
			'label'       => esc_html__( 'Lightbox ID', 'sb-bricks-tweaks' ),
			'type'        => 'text',
			'inline'      => true,
			'description' => esc_html__( 'Galleries sharing an ID are grouped together.', 'sb-bricks-tweaks' ),
			'required'    => [ 'lightbox', '=', true ],
		];
		...
		$this->controls['altInfo'] = [
			...
			'group'   => 'seo',
			'type'    => 'info',
			'content' => esc_html__( 'By default each image uses the alt text set on the media item. Use the field below as a fallback for images that have none.', 'sb-bricks-tweaks' ),
		];

		$this->controls['altText'] = [
			'tab'         => 'content',
			'group'       => 'seo',
			'label'       => esc_html__( 'Custom alt text', 'sb-bricks-tweaks' ),
			'type'        => 'text',
			'hasDynamicData' => 'text',
			'description' => esc_html__( 'Add {index} to number the images, for example: Kitchen renovation Brisbane {index}', 'sb-bricks-tweaks' ),
		];

		$this->controls['altOverride'] = [
			'tab'         => 'content',
			'group'       => 'seo',
			'label'       => esc_html__( 'Override existing alt text', 'sb-bricks-tweaks' ),
			'type'        => 'checkbox',
			'description' => esc_html__( 'Forces every image to use the custom alt text, even when the media item already has one.', 'sb-bricks-tweaks' ),
		];
	}
	...
	public function render() {
		...
		if ( empty( $images ) ) {
			return $this->render_element_placeholder(
				[ 'title' => esc_html__( 'Select images, or bind a gallery field.', 'sb-bricks-tweaks' ) ]
			);
		}
		...
		if ( $keyboard ) {
			...
			$this->set_attribute( '_root', 'aria-roledescription', esc_attr__( 'carousel', 'sb-bricks-tweaks' ) );
			$this->set_attribute( '_root', 'aria-label', esc_attr__( 'Image carousel. Use the left and right arrow keys to move between slides.', 'sb-bricks-tweaks' ) );
		}
		...
		if ( ! empty( $settings['showArrows'] ) ) {
			...
			echo '<button class="splide__arrow splide__arrow--prev" type="button" aria-label="' . esc_attr__( 'Previous slide', 'sb-bricks-tweaks' ) . '">' . $prev_icon . '</button>';
			echo '<button class="splide__arrow splide__arrow--next" type="button" aria-label="' . esc_attr__( 'Next slide', 'sb-bricks-tweaks' ) . '">' . $next_icon . '</button>';
			echo '</div>';
		}
